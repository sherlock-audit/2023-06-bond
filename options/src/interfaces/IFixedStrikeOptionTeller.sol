...
interface IFixedStrikeOptionTeller is IOptionTeller {
    ...
    // /// @notice         Get the FixedStrikeOptionToken contract corresponding to a market
    // /// @param id_      ID of the market
    // /// @return token_  FixedStrikeOptionToken contract address
    // function getOptionTokenForMarket(uint256 id_) external view returns (FixedStrikeOptionToken);
